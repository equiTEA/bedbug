...
export const landlordChipStyles = ({ theme, selected }: BaseProps) => ({
  p: 1,
  px: 0,
  height: '24px',
...
export const createNewLandlordListItemStyles = ({
  theme,
  selected,
}: BaseProps) => ({
...
export const createNewLandlordIconStyles = ({
  theme,
  selected,
}: BaseProps) => ({
  mr: 1,
...
export const doingBusinessAsLabelStyles = ({ theme, selected }: BaseProps) => ({
  mt: 1,
...
export const doingBusinessAsChipStyles = ({ theme, selected }: BaseProps) => ({
  mr: 0.5,
  mb: 0.25,
  height: '18px',
  px: `0 !important`,
...
export const selectedLandlordChipStyles = ({ theme }: { theme: Theme }) => ({
  color: `${theme.palette.secondary.main} !important`,
  height: '24px',
  '.MuiChip-deleteIcon': {
    height: '18px',
