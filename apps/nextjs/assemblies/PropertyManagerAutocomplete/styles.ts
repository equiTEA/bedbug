...
export const propertyManagerChipStyles = ({ theme, selected }: BaseProps) => ({
  p: 1,
  px: 0,
  height: '24px',
...
export const createNewPropertyManagerListItemStyles = ({
  theme,
  selected,
}: BaseProps) => ({
...
export const createNewPropertyManagerIconStyles = ({
  theme,
  selected,
}: BaseProps) => ({
  mr: 1,
...
export const selectedPropertyManagerChipStyles = ({
  theme,
}: {
  theme: Theme
}) => ({
